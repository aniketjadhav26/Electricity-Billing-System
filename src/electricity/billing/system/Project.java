...
public class Project extends JFrame implements ActionListener {
    ...
    Project(String atype, String meter) {
        ...
        JMenuItem customerdetils = new JMenuItem("Customer Details");
        customerdetils.setFont(new Font("menospaced", Font.PLAIN, 12));
        customerdetils.setBackground(Color.WHITE);
        ImageIcon icon2 = new ImageIcon(ClassLoader.getSystemResource("icons/icon2.png"));
        Image image2 = icon2.getImage().getScaledInstance(20, 20, Image.SCALE_DEFAULT);
        customerdetils.setIcon(new ImageIcon(image2));
        customerdetils.setMnemonic('M');
        customerdetils.addActionListener(this);
        customerdetils.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_M, ActionEvent.CTRL_MASK));
        master.add(customerdetils);
        ...
        updateinformation.setMnemonic('A');
        ...
        exit.setFont(new Font("menospaced", Font.PLAIN, 12));
